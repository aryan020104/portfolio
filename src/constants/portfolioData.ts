...
export const PERSONAL_INFO: Record<Language, {
  ...
  de: {
    ...
    twitter: "https://x.com",
    availability: "Offen für Praktikum & Werkstudentenstellen",
    yearsExperience: "2+",
    projectsCompleted: "7+",
  ...
  en: {
    ...
    linkedin: "https://linkedin.com",
    twitter: "https://x.com",
    availability: "Open for Internships & Working Student Roles",
    yearsExperience: "2+",
    projectsCompleted: "7+",
    technologiesMastered: "10+",
    githubContributions: "500+",
...
export const UI_STRINGS: Record<Language, {
  ...
  de: {
    ...
    contact: {
      ...
      directDesc: "Kontaktieren Sie mich gerne für Praktika, Werkstudentenstellen, Software Engineering Anfragen oder technische Zusammenarbeit.",
      email: "E-Mail",
      phone: "Telefon",
      ...
      subjectPlaceholder: "z.B. Praktikum / Werkstudent / Software Engineering",
  ...
  en: {
    ...
    experience: {
      badge: "Experience & Academics",
      headingPart1: "Academic &",
      headingHighlight: "Engineering Milestones",
      ...
      specializationList: [
        "Software Design International B.Sc. (EQR Level 6)",
        "Java Backend Architecture (Spring Boot, Hibernate, MySQL)",
        "Drone Network Optimization & DevSecOps CI/CD Pipelines"
      ]
    },
    certificates: {
      badge: "Certifications & GitHub",
      headingPart1: "Academic & Tech",
    ...
    contact: {
      ...
      directDesc: "Feel free to reach out for Internship opportunities, Working Student roles, or software engineering collaboration.",
      email: "Email",
      phone: "Phone",
      ...
      subjectPlaceholder: "e.g. Internship / Working Student Role / Software Engineering",
